...
public class Login_Supervisor extends AppCompatActivity {
    ...
    public void validasi() {
        ...
        if (nama.isEmpty() && password.isEmpty()) {
            ...
            //LENGTH_SHORT = 2.5 s
            Toast.makeText(Login_Supervisor.this, "Login Sukses", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(Login_Supervisor.this, "Username Salah", Toast.LENGTH_SHORT).show();

        } else if (nama.equals("ihsan") && password != ("ihsan")) {
            Toast.makeText(Login_Supervisor.this, "Password Salah", Toast.LENGTH_SHORT).show();
        } else if (nama != ("ihsan") && password != ("ihsan")) {
            Toast.makeText(Login_Supervisor.this, "Username dan Password Salah", Toast.LENGTH_SHORT).show();
        }
